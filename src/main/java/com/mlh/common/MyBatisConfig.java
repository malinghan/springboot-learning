...
import com.mlh.datasource.DynamicDataSource;
...
public class MyBatisConfig implements EnvironmentAware {
    ...
    public SqlSessionFactory sqlSessionFactory(DynamicDataSource ds) throws Exception {
        ...
        fb.setMapperLocations(
                new PathMatchingResourcePatternResolver().getResources(env.getProperty("mybatis.mapperLocations")));//mapper.xml文件地址
        return fb.getObject();
    }
